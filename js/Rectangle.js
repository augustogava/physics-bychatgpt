class Rectangle extends Shape {
    ...
    draw(ctx) {
        ...
        // var fv = MathHelper.getLinerInterpolation(this.position.y, 0, -30, canvas.height, 80);
        // var radgrad = ctx.createRadialGradient(this.position.x, this.position.y, 0, 0, this.height, this.height);

        // radgrad.addColorStop(1, this.color);
        // radgrad.addColorStop(1, Utils.changeRedSoftness(this.color, 220));
        // radgrad.addColorStop(1, Utils.changeRedSoftness(this.color, 180));
    ...
    debug(){
        ...
        ctx.fillText(`Rectangle X: ${this.position.x.toFixed(2)}`, 0, 5 * this.debugObj.fontSize);
        ctx.fillText(`Rectangle Y: ${this.position.y.toFixed(2)}`, 0, 6 * this.debugObj.fontSize);
        ctx.fillText(`Rectangle Width: ${this.width.toFixed(2)}`, 0, 7 * this.debugObj.fontSize);
        ctx.fillText(`Rectangle Height: ${this.height.toFixed(2)}`, 0, 8 * this.debugObj.fontSize);
        ctx.restore();
    }
